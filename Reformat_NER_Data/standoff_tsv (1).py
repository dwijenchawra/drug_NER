    ...
    for s,t in split:
        ...
        if t == 'O':
            ...
            if len(tokens) == 1:
                ...
                output.append((line, tokens[0], 'B-' + t))
                for i in range(1, len(tokens) - 1):
                    output.append((line, tokens[i], 'I-' + t))
                output.append((line, tokens[-1], 'L-' + t))
...
def main():
    standoff_to_tsv("training_20180910/100035.ann", "training_20180910/100035.txt", "Sample_tsv.tsv")
