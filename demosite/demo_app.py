...
#nlp = pipeline("ner", model="/home/x-dchawra/sem2battelle/bert-info-extraction/model/biobert-base-cased-v1.2/", tokenizer="bert-base-cased")
...
def download(filename):
    with app.app_context():
        ...
        # export to html file
        with open("spacyrenders/" + file + ".html", "w") as f:
            f.write(html)
